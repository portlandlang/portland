...
- [#73](https://github.com/portlandlang/portland/issues/73) — five probed spellings: `until` and the postfix loops shipped, `loop do` declined ([ADR 0037](docs/adr/0037-2026-08-18-the-loop-spellings.md)); `||=` and subjectless `case` still open there
