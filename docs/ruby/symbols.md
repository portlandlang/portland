...
**Status:** decided ([ADR 0023](../adr/0023-2026-07-25-symbols.md)). Built in the seed and the compiler, differentially pinned — see [the language](../language.md#symbols-and-enums).
