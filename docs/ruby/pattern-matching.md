...
evaluator dispatches on its own AST with struct patterns. The static half
(exhaustiveness, unreachable arms, the unused-capture lint) waits for #9,
previewed as runtime panics.
