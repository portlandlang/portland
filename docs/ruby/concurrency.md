...
- `together do ... end` parses as a Ruby method-with-block, and `~ x = y` parses as Ruby too — the polyfill gem can make the vocabulary *run* (serially) in Ruby before the flip.
